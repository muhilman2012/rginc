                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="ig_username" value="{{ old('ig_username') }}" required 
                            class="w-full bg-slate-900 border border-slate-700 rounded-lg pl-9 pr-4 py-2.5 text-white focus:outline-none focus:border-rginc-gold focus:ring-1 focus:ring-rginc-gold transition">
                    </div>
